...
class Config:
    ...
    # === 閫夎偂 / 鎵弿閰嶇疆 ===
    stock_picker_enabled: bool = True
    stock_picker_schedule_enabled: bool = True
    stock_picker_default_strategy: str = "mainboard_swing_master"
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            tushare_api_url=(os.getenv('TUSHARE_API_URL') or 'http://api.tushare.pro').rstrip('/'),
